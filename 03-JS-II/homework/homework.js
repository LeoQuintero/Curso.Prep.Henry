...
function saludo(idioma) {
  ...
  if(idioma==='ingles') return "Hello!"; else{
    return 'Hola!';
  }
}
...
function esEntero(numero) {
  ...
  // Tu código:
  if(numero - Math.floor(numero) === 0) return true;else{
    return false;
  }
}
...
function fizzBuzz(numero) {
  ...
  if (numero%5 === 0) return "buzz";else{
    return numero;
  }
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if(num3>num1 && num3>num2) return num3 + 1;else{
    return false;
  }
...
function esVerdadero(valor){
  ...
  if(valor) return 'Soy verdadero';else{
    return 'Soy falso';
  }
...
function tieneTresDigitos(numero){
  ...
  numeroSplit = numeroStr.split("")
  return numeroSplit.length === 3? true:false; 
}
